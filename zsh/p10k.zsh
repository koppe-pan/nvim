# Generated by Powerlevel10k configuration wizard on 2025-06-13 at 17:10 JST.
# Based on romkatv/powerlevel10k/config/p10k-rainbow.zsh.
# Wizard options: awesome-fontconfig, small icons, rainbow, ascii, 2 lines, solid,
...
() {
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_ERROR_VIINS_CONTENT_EXPANSION='；ω；>'
